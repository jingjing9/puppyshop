    ...
    function init() {
        ...
        $.each(data,function (i,v) {
            ...
            $('tbody').append(
                ...
                // '<td> <span> <button type="submit" data-index="'+i+'" class="btn btn-info"  data-toggle="modal" data-target="#myModal"style="width: 80px;background-color: #ffcd04;border: none"> <span class="glyphicon glyphicon-trash" aria-hidden="true">评论</span> </button> </span> </td> ' +

                '<td> <span> <a href="serviceAppraise.html" target="con"><button type="submit" class="btn btn-info" style="width: 80px;background-color: #ffcd04;border: none">评论</button> </a> </span> </td> ' +
